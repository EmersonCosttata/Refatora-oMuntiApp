...
import QRCodeGenerator from "./components/Pages/QRCodeGenarator";
...
const QRCodeGenerator = lazy(() => import('./components/Pages/QRCodeGenarator')) // Componentes com lazy loading adcionados para fluidez de carregamento.
  ...
  return (
    <AppContainer>
      ...
      <MainContent>  
        ...
        {isAuthenticated && <Footer>© 2024 Emerson Costa | All rights reserved</Footer>}
      </MainContent>
      </Suspense>
    </AppContainer>
  );
